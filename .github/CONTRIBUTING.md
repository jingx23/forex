...
* Use [github issues](https://github.com/jingx23/forex/issues) to report a bug.
* Before creating a new issue:
  * Make sure you are using the [latest release](https://github.com/jingx23/forex/releases).
  * Check if the issue was [already reported or fixed](https://github.com/jingx23/forex/issues?utf8=%E2%9C%93&q=is%3Aissue). Notice that it may not be released yet.
...
1. Fork the Forex repository.
2. Clone your forked project into your developer machine: `git clone git@github.com:<your-github-username>/forex.git`
3. Add the original project repo as upstream repository in your forked project: `git remote add upstream git@github.com:jingx23/forex.git`
...
We use swift [SwiftLint](https://github.com/realm/SwiftLint) to enforce Swift style and conventions. We would love to hear your ideas to improve our code style and conventions. Feel free to contribute.
...
* We use `type: feature request` label to mark all [feature request issues](https://github.com/jingx23/forex/labels/type%3A%20feature%20request).
